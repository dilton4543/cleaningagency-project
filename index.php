    ...
    <div class="services-section">
       <div class="services">
        <h1 style="text-align: center;" id="servicesoffered">Services Offered</h1> <br><br>
            ...
            <button style="background-color: #2b98f0; border: 1px solid #2b98f0; padding: 10px 10px; margin-left: 35rem;"><a href="/cleaningagency/service_request.php" style="text-decoration: none; color: white; font-weight: bold;">Book a service now!</a></button>
        </div>
    </div> <br><br><br>
